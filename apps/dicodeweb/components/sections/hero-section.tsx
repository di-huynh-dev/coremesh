...
const socialLinks = [
  { href: 'https://github.com/hoodini', icon: GitHubIcon, label: 'GitHub' },
  { href: 'https://www.linkedin.com/in/%F0%9F%8E%97%EF%B8%8Fyuval-avidani-87081474/', icon: LinkedInIcon, label: 'LinkedIn' },
  { href: 'https://twitter.com/yuvai', icon: XIcon, label: 'X' },
